...
If you would rather not write proxy config at all, this repo ships a Traefik override that reads its routing off container labels and handles Let's Encrypt for you — see [Reverse Proxy](https://github.com/multica-ai/multica/blob/main/SELF_HOSTING_ADVANCED.md#reverse-proxy). The rest of this page uses Caddy.
